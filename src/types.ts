...
// Default reasoning effort: 'xhigh' for maximum depth. Override via CODEX_REASONING_EFFORT env var or per-call param.
export const DEFAULT_REASONING_EFFORT = (process.env.CODEX_REASONING_EFFORT || 'xhigh') as 'none' | 'minimal' | 'low' | 'medium' | 'high' | 'xhigh';
